...
const BulgarianTVShowsCategory: CategoryMetadata = {
  ...
  examples: [
    ...
    },
    {
      ...
      image: "последниятпечели.jpg",
      alternatives: [],
    },
    {
      name: "Черешката на тортата",
      image: "черешкатанатортата.png",
      alternatives: [],
    },
    {
      name: "Кошмари в кухнята",
      image: "кошмаривкухнята.jpg",
      alternatives: [],
    },
    {
      name: "Сделка или не",
      image: "сделкаилине.jpg",
      alternatives: ["Deal or No Deal Bulgaria"],
    },
    {
      name: "Шоуто на Слави",
      image: "шоутонаслави.jpg",
      alternatives: [],
    },
    {
      name: "Господари на ефира",
      image: "господаринаефира.jpg",
      alternatives: [],
    },
    {
      name: "Комиците",
    ...
    },
    {
      ...
      image: "шоутонаниколаос.jpg",
      alternatives: [],
    },
    {
      name: "Преди обед",
      image: "предиобед.webp",
      alternatives: [],
    },
    {
      name: "Мармалад",
    ...
    {
      name: "Съдебен спор",
      image: "съдебенспор.jpg",
      alternatives: [],
    },
    {
      name: "Минута е много",
      image: "минутаемного.webp",
      alternatives: [],
    },
    {
      name: "Бригада Нов Дом",
      image: "бригадановдом.jpg",
      alternatives: [],
    },
    {
      name: "The Floor",
    ...
    {
      name: "120 минути",
      image: "120минути.jpeg",
      alternatives: [],
    },
    {
      name: "Аз обичам България",
      image: "азобичамбългария.jpg",
      alternatives: [],
    },
    {
      name: "Лека нощ деца",
      image: "леканощдеца.jpg",
      alternatives: ["Сънчо"],
    },
    {
      name: "Риск печели риск губи",
      image: "рискгубирискпечели.jpg",
      alternatives: [],
    },
    {
      name: "Спорт Тото",
...
const BulgarianLandmarksCategory: CategoryMetadata = {
  ...
  examples: [
    ...
    {
      name: "Boyana Church",
      image: "boyanachurch.jpg",
      alternatives: [],
    },
    {
      name: "Tsarevets",
      image: "tsarevets.jpeg.webp",
      alternatives: ["Tsarevets"],
    },
    {
      name: "Bachkovo Monastery",
      image: "bachkovskimanastir.jpg",
      alternatives: [],
    },
    {
    ...
    {
      name: "Perperikon",
      image: "perpericon.jpg",
      alternatives: [],
    },
    {
      name: "Devetashka Cave",
      image: "devetashkacave.jpeg.webp",
      alternatives: [],
    },
    {
    ...
    },
    {
      ...
      image: "dqvolskotogurlo.jpg.webp",
    ...
    },
    {
      ...
      image: "chudnitemostove.jpeg",
      alternatives: [],
    },
    {
      name: "Pobiti Kamani",
      image: "pobitikamuni.jpg",
...
export const CATEGORY_METADATA: Record<Category, CategoryMetadata> = {
  ...
  "Bulgarian TV Shows": BulgarianTVShows,
