...
const BulgarianTVShowsCategory: CategoryMetadata = {
  ...
  examples: [
    ...
    {
      name: "Минута е много",
      text: "минутаемного.webp",
      alternatives: [],
    },
    {
      name: "Бригада Нов Дом",
      text: "бригадановдом.jpg",
      alternatives: [],
    },
    {
      name: "The Floor",
    ...
    },
    {
      ...
      text: "азобичамбългария.jpg",
      alternatives: [],
    },
    {
      name: "Лека нощ деца",
      text: "леканощдеца.jpg",
      alternatives: ["Сънчо"],
    },
    {
      name: "Риск печели риск губи",
      text: "рискгубирискпечели.jpg",
      alternatives: [],
    },
    {
      name: "Спорт Тото",
